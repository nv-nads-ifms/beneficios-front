...
import LogradouroTableRow from './LogradouroTableRow';
...
export default function LogradouroListagemModal(props) {
    ...
    React.useEffect(() => {
        ...
        LogradouroService.getLogradouros(params)
            .then((resp) => {
                setDataFetched(true);
                setData(resp.data)
